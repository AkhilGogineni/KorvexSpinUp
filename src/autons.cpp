...
void BlueLeft() {  
  ...
  chassis.wait_drive();
  wait(500);
  chassis.set_turn_pid(-9, TURN_SPEED); //turn to high goal
  chassis.wait_drive();
  wait(400);
  indexer.set_value(true);
  intake.moveRelative(950,450);
  wait(1100);
  intake.moveRelative(835,450);
  wait(1100);
  intake.moveRelative(1000,450);
  wait(400);
  wait(500);
...
void RedSoloWP() {
  ...
  chassis.wait_drive();
  spinIntake();
  chassis.set_drive_pid(74, DRIVE_SPEED, true);
  chassis.wait_drive();
